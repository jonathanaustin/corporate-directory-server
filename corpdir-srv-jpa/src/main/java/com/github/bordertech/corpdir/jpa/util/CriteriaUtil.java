...
public final class CriteriaUtil {
	...
	public static <T extends PersistIdObject> Predicate createSearchIDCriteria(final CriteriaBuilder cb, final Root<T> root, final Long id) {
	 ...
	 */
	public static <T extends PersistIdObject> Predicate createSearchTextIdCriteria(final CriteriaBuilder cb, final Root<T> root, final String search) {
	 ...
	 * @return the predicate search
	 */
	public static <T extends PersistKeyIdObject> Predicate createSearchTextKeyIdCriteria(final CriteriaBuilder cb, final Root<T> root, final String search) {
		Predicate p1 = cb.like(root.<String>get("description"), "%" + search + "%");
	 ...
	 */
	public static <T extends PersistIdObject> Order getDefaultOrderBy(final CriteriaBuilder cb, final Root<T> root) {
