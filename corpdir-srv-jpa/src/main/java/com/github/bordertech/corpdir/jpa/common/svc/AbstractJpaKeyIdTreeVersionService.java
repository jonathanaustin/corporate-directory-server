 ...
 */
@Singleton
public class AbstractJpaKeyIdTreeVersionService<A extends ApiTreeable & ApiVersionable & ApiKeyIdObject, P extends PersistentTreeable<P> & PersistentKeyIdObject> extends AbstractJpaKeyIdService<A, P> implements BasicTreeVersionService<A> {
...
//			entity.removeChild(subOrgUnit);
	...
	@Override
	public DataResponse<List<A>> getSubs(Integer versionId, String keyId) {
		throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
	}

	@Override
	public DataResponse<A> addSub(Integer versionId, String keyId, String subKeyId) {
		throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
	}

	@Override
	public DataResponse<A> removeSub(Integer versionId, String keyId, String subKeyId) {
		throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
	}
