...
public class AbstractToolbar<T> extends DefaultView<T> implements ToolbarView<T> {
	...
	@Override
	public void addToolbarType(final ToolbarType... types) {
	...
	@Override
	public void removeToolbarType(final ToolbarType... types) {
		ToolbarModel model = getOrCreateComponentModel();
		if (model.toolbarTypes != null) {
	...
	@Override
	public Set<ToolbarType> getToolbarTypes() {
	...
	@Override
	public boolean isUseToolbarType(final ToolbarType type) {
		ToolbarModel model = getComponentModel();
	...
	public static class ToolbarModel extends DefaultView.ViewModel {
		...
		private Set<ToolbarType> toolbarTypes;
	}
