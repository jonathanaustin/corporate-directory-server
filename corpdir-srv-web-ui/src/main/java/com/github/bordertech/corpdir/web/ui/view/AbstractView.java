...
import com.github.bordertech.corpdir.web.ui.common.ViewMode;
...
public abstract class AbstractView<T> extends WSection implements MessageContainer {
	 ...
	 */
	public AbstractView(final String title, final CorpDirApp app) {
		super(title);
		this.app = app;
	...
	protected abstract void doSaveSuccessful();
